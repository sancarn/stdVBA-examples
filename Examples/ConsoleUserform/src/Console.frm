...
MulitlineEnd:
    ...
    Private Function RunApplication(Arguments() As Variant) As Variant
        ...
        Select Case UBound(Arguments)
            Case 0:    RunApplication = Application.Run(Arguments(0))
            Case 1:    RunApplication = Application.Run(Arguments(0), Arguments(1))
            Case 2:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2))
            Case 3:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3))
            Case 4:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3), Arguments(4))
            Case 5:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3), Arguments(4), Arguments(5))
            Case 6:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3), Arguments(4), Arguments(5), Arguments(6))
            Case 7:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3), Arguments(4), Arguments(5), Arguments(6), Arguments(7))
            Case 8:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3), Arguments(4), Arguments(5), Arguments(6), Arguments(7), Arguments(8))
            Case 9:    RunApplication = Application.Run(Arguments(0), Arguments(1), Arguments(2), Arguments(3), Arguments(4), Arguments(5), Arguments(6), Arguments(7), Arguments(8), Arguments(9))
            ...
            Else
                Select Case Mid(CurrentLine, i, 1)
                    Case Is = "("
                        ...
                        If Para_Counter Mod 2 = 0 Then Color = Color + &H333300
                        ConsoleText.SelColor = Color
                    Case Is = ")"
                        Color = in_Parantheses
                        If Para_Counter Mod 2 = 0 Then Color = Color + &H333300
                    ...
                    For i = 1 To CodeMod.CountOfLines
                        ...
                        If UCase(CurrentRow) Like "*PUBLIC *" And InStr(1, CurrentRow, "'") = 0 And Not UCase(CurrentRow) Like "*" & Chr(34) & "*PUBLIC*" & Chr(34) & "*" Then
                            ...
                            Else
                                ...
                                Select Case True
                                    Case UCase(CurrentRow) Like "*PUBLIC ENUM*"
