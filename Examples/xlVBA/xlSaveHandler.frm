VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} xlSaveHandler 
   Caption         =   "Microsoft Excel"
   ClientHeight    =   1500
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   6240
   OleObjectBlob   =   "xlSaveHandler.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "xlSaveHandler"
...
Public Event BeforeShow(obj As xlSaveHandler)
Public Event AfterShow(obj As xlSaveHandler)
...
Public Function Create(wb As Workbook) As xlSaveHandler
  Dim obj As xlSaveHandler
  Set obj = New xlSaveHandler
  obj.Init wb
  Set Create = obj
End Function
